...
- [x] Backend server starts and serves API endpoints
- [x] Web client connects to backend and displays a list of media
- [x] Media files can be played back in the web client
- [x] Basic configuration management is implemented
- [x] All code passes linting and tests
...
- [x] Service to scan specified directories for media files
- [x] Basic metadata extraction (filename, size, modified date)
- [x] In-memory storage of scanned media data

#### 3. Media Streaming

- [x] Endpoint to stream media files directly
- [x] Streams .mp4 files with proper headers
- [x] Basic error handling for missing files
...
- [x] Web client connects to backend and displays a list of media
- [x] Media files can be played back in the web client
- [x] Simple UI with a list view of media items
- [x] Video player component for playback of .mp4 files
...
- [x] Configurable media directories for scanning
